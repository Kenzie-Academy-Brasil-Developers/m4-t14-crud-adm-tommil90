import { iUserRequest, tUserResult, tUserWithoutPassword } from '../../interfaces/users.interfaces'
...
export const createUsersService = async (userData: iUserRequest): Promise<tUserWithoutPassword> => {
